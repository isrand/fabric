  ...
  jq '.channel_group.groups.Application.groups.Org1MSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0-org1","port": 7051}]},"version":"0"}}' config.json > modified_anchor_config.json;
